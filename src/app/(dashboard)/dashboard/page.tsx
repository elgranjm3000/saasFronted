  ...
  return (
    <div className="flex min-h-screen bg-slate-50">
      ...
      `}>
        ...
        {/* Navigation */}
        <nav className="flex-1 mt-6 px-3 sm:px-4 pb-20 overflow-y-auto">
        ...
        <div className="absolute bottom-4 left-3 right-3 sm:left-4 sm:right-4">
          <div className="bg-slate-50 rounded-xl p-3 sm:p-4">
            <div className="flex items-center min-w-0">
              <div className="w-10 h-10 bg-slate-200 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-slate-500 truncate">Plan Professional</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-center justify-between h-16 px-4 sm:px-6">
            <div className="flex items-center min-w-0">
              <button
                ...
                className="text-slate-500 hover:text-slate-700 lg:hidden mr-3"
              >
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="relative hidden md:block">
                ...
                <input
                  type="text"
                  placeholder="Buscar..."
                  className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent w-48 lg:w-64"
                />
              </div>
              ...
              <div className="relative">
                <button
                  ...
                  className="flex items-center space-x-2 sm:space-x-3 text-sm bg-white border border-slate-300 rounded-lg px-2 sm:px-3 py-2 hover:bg-slate-50"
                >
                  <div className="w-7 h-7 sm:w-8 sm:h-8 bg-blue-600 rounded-lg flex items-center justify-center">
                    <User className="w-3 h-3 sm:w-4 sm:h-4 text-white" />
                  </div>
                  <span className="hidden sm:block font-medium text-slate-700 max-w-20 lg:max-w-none truncate">
                    {user?.username || 'Admin'}
                  </span>
              ...
              {statsCards.map((card, index) => (
                <div key={index} className="bg-white rounded-xl shadow-sm border border-slate-200 p-4 sm:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 ${card.color} rounded-lg flex items-center justify-center ml-3`}>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-slate-200">
                  ...
                  <div className="p-4 sm:p-6 space-y-3">
                    <button className="w-full flex items-center justify-center px-4 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm sm:text-base">
                      <FileText className="w-4 h-4 mr-2" />
                      Nueva Factura
                    </button>
                    <button className="w-full flex items-center justify-center px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors text-sm sm:text-base">
                      <Package className="w-4 h-4 mr-2" />
                      Agregar Producto
                    </button>
                    <button className="w-full flex items-center justify-center px-4 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors text-sm sm:text-base">
